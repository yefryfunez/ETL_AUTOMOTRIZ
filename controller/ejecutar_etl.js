        ...
        try {
                    ...
                    /* ************************************************************** CARGA ***************************************************************** */
                            try {
                                ...
                                resultado.forEach(async objeto=>{//2FOR CADA REGISTRO
                                    let icampos = 0;
                                    const request = pool.request();
                                            for(let prop in objeto){
                                                ...
                                                //ELIMINAR ESPACIOS EN BLANCO A LOS EXTREMOS DE UNA CADENA
                                                if(typeof objeto[prop] === 'string') data = objeto[prop].trim();
                                                else data = parseFloat(objeto[prop]);
                                                
                                                //CONVERTIR EN MAYUSCULA O MINUSCULA EL DATO SI SE HA ESTABLECIDO QUE LO HAGA
                                                ...
                                                //console.log(elemento.campos_tabla_olap[icampos].campo_destino, ' , ', tipo_dato,' , ', data);
                                ...
                                console.log('ocurrio un error con el etl: ',elemento.destino)
